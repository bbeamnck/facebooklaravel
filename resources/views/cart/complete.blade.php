...
<table border="0" width="100%">
    ...
    <tr>
        <td>
            <table border="0" width="100%">
                <tr><td width="20%"><strong>ชื่อลูกค้า:</strong></td>
                    <td>{{ $cust_name }}</td>
                </tr>
                <tr><td width="20%"><strong>อีเมล:</strong></td>
                    <td>{{ $cust_email  }}</td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td>
            ...
            <ul>
                ...
                <li>ชำระเงินแล้วส่งหลักฐานมาที่ sales@blikeshop.com หรือ LINE: @blikeshop</li>
            </ul>
        </td>
